...
# COMPLETAR - INICIO
strings_concatenados = "{0}{1}{2}".format("¡Mamá ","estoy concatenando ","strings!" )
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
strings_concatenados = "{0}{1}{2}{3}{4} Se llama {5}".format(variable_01, variable_02, variable_03, variable_02, variable_04, variable_05)
# COMPLETAR - FIN
